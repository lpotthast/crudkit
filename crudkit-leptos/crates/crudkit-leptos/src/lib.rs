...
pub mod crud_field_label_leptos;
...
pub mod crud_table_footer_leptos;
...
pub mod prelude {
    ...
    pub use super::crud_field_label_leptos::CrudFieldLabelL;
    ...
    pub use super::crud_table_footer_leptos::CrudTableFooterL;
