use crate::dynamic::custom_field::{
    CustomCreateFields, CustomField, CustomReadFields, CustomUpdateFields,
};
...
pub fn CrudField<F: DynField>(
    custom_fields: Signal<HashMap<F, CustomField<F>>>,
    field_config: Signal<HashMap<F, DynSelectConfig>>,
